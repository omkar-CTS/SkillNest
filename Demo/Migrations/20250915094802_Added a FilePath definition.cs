...
{
    /// <inheritdoc />
    public partial class AddedaFilePathdefinition : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "Id", "Email", "Location", "Name", "Role" },
                values: new object[,]
                {
                    { 1, "omkar@gmail.com", "Hyderabad", "Omkar Bajaga", "Employee" },
                    { 2, "rahul@gamil.com", "Pune", "Rahul", "Manager" }
                });
